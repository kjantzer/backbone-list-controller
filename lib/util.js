...
Backbone.View.prototype.renderTemplate = function(data, template){
	...
	data = !data && this.model && this.model.templateData ? this.model.templateData() : data;
...
// _.template = function(text, attrs){
// 	if( !text ){
// 		console.warn('Template not found', arguments);
// 		return 'Template not found'
// 	}
// 			
// 	return _template.call(_, text)(attrs)
// }
...
_.mixin({
	...
	store: amplify.store,
	score: LiquidMetal.score.bind(LiquidMetal),
